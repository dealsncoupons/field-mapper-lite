...
public class LocalCache {
    ...
    private final Map<String, Map<String, Hydrant>> localCache = new ConcurrentHashMap<>();
    ...
    public <E extends Hydrant> Optional<E> get(UUID idValue, String tableName) {
    ...
    public <E extends Hydrant> void add(UUID idValue, E entity, String tableName) {
        if (this.localCache.containsKey(tableName)) {
            ...
            Map<String, Hydrant> newTableCache = new ConcurrentHashMap<>();
