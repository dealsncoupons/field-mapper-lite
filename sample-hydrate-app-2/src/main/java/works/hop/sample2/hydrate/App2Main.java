...
public class App2Main {
    ...
    public static final DbSelector DB_SELECTOR = DbSelector.selector();
...
//
    ...
    private static void createTaskEntity() {
        ...
        if (idField != null) {
            ...
            Task entity = DB_SELECTOR.selectByIdColumn(taskToFind, entityInfo.getTableName(), pkColumn, searchId);
    ...
    private static void retrieveUserEntity() {
        ...
        if (idField != null) {
            String pkColumn = idField.columnName;
            User entity = DB_SELECTOR.selectByIdColumn(user, entityInfo.getTableName(), pkColumn, pkValue);
            System.out.println("Found entity -> " + entity.getId().toString() + ", expected UUID -> " + searchId);
        }
    }
    ...
    private static void retrieveAccountEntity() {
        ...
        if (idField != null) {
            String pkColumn = idField.columnName;
            Account entity = DB_SELECTOR.selectByIdColumn(account, entityInfo.getTableName(), pkColumn, pkValue);
            System.out.println("Found entity -> " + entity.getId().toString() + ", expected UUID -> " + searchId);
        }
    }
    ...
    private static void retrieveTaskEntity() {
        ...
        if (idField != null) {
            String pkColumn = idField.columnName;
            Task entity = DB_SELECTOR.selectByIdColumn(task, entityInfo.getTableName(), pkColumn, pkValue);
            System.out.println("Found entity -> " + entity.getId().toString() + ", expected UUID -> " + searchId);
