...
package works.hop.sample2.hydrate.entity.dispatcher;
...
public class ChangeDispatcherChain implements ChangeDispatcher {
  ...
  public void initialize() {
    this.dispatchers.add(new works.hop.sample2.hydrate.entity.dispatcher.AccountEventDispatcher());
    this.dispatchers.add(new works.hop.sample2.hydrate.entity.dispatcher.AssignmentEventDispatcher());
    this.dispatchers.add(new works.hop.sample2.hydrate.entity.dispatcher.TaskEventDispatcher());
    this.dispatchers.add(new works.hop.sample2.hydrate.entity.dispatcher.UserEventDispatcher());
